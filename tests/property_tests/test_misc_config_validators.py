...
class TestMiscConfigValidators:
    """Property-based tests for MiscConfig validators."""
    ...
    def test_validate_cidr_with_valid_notation(self, cidr):
    ...
    def test_validate_cidr_with_missing_prefix(self, invalid_cidr):
    ...
    def test_validate_cidr_with_invalid_notation(self, invalid_cidr):
    ...
    def test_validate_cidr_with_none(self):
